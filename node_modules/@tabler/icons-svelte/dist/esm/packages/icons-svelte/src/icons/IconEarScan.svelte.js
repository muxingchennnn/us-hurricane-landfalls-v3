...
/* src/icons/IconEarScan.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "ear-scan" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconEarScan extends SvelteComponent {
	constructor(options) {
		super();
...
var IconEarScan$1 = IconEarScan;

export { IconEarScan$1 as default };
//# sourceMappingURL=IconEarScan.svelte.js.map
