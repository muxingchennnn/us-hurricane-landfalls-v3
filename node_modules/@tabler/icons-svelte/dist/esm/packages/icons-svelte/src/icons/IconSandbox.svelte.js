...
/* src/icons/IconSandbox.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sandbox" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSandbox extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSandbox$1 = IconSandbox;

export { IconSandbox$1 as default };
//# sourceMappingURL=IconSandbox.svelte.js.map
