...
/* src/icons/IconGymnastics.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "gymnastics" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGymnastics extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGymnastics$1 = IconGymnastics;

export { IconGymnastics$1 as default };
//# sourceMappingURL=IconGymnastics.svelte.js.map
