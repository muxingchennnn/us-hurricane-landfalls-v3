...
/* src/icons/IconPinInvoke.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pin-invoke" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPinInvoke extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPinInvoke$1 = IconPinInvoke;

export { IconPinInvoke$1 as default };
//# sourceMappingURL=IconPinInvoke.svelte.js.map
