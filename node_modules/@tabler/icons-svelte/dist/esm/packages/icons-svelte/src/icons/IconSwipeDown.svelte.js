...
/* src/icons/IconSwipeDown.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "swipe-down" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [
		[
			"path",
			{
				"d": "M12 4a4 4 0 1 1 0 8a4 4 0 0 1 0 -8z"
			}
		],
		["path", { "d": "M12 12v8" }],
...
class IconSwipeDown extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSwipeDown$1 = IconSwipeDown;

export { IconSwipeDown$1 as default };
//# sourceMappingURL=IconSwipeDown.svelte.js.map
