...
/* src/icons/IconFileSad.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-sad" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileSad extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileSad$1 = IconFileSad;

export { IconFileSad$1 as default };
//# sourceMappingURL=IconFileSad.svelte.js.map
