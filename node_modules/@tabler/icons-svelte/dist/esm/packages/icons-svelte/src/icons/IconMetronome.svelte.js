...
/* src/icons/IconMetronome.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "metronome" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [
		...
		[
			"path",
			{
				"d": "M20 5m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0"
			}
		]
	];
...
class IconMetronome extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMetronome$1 = IconMetronome;

export { IconMetronome$1 as default };
//# sourceMappingURL=IconMetronome.svelte.js.map
