...
/* src/icons/IconBackground.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "background" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBackground extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBackground$1 = IconBackground;

export { IconBackground$1 as default };
//# sourceMappingURL=IconBackground.svelte.js.map
