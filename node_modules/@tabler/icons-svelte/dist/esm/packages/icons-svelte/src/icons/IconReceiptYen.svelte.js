...
/* src/icons/IconReceiptYen.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "receipt-yen" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconReceiptYen extends SvelteComponent {
	constructor(options) {
		super();
...
var IconReceiptYen$1 = IconReceiptYen;

export { IconReceiptYen$1 as default };
//# sourceMappingURL=IconReceiptYen.svelte.js.map
