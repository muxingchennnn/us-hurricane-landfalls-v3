...
/* src/icons/IconFileSmile.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "file-smile" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFileSmile extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFileSmile$1 = IconFileSmile;

export { IconFileSmile$1 as default };
//# sourceMappingURL=IconFileSmile.svelte.js.map
