...
/* src/icons/IconSwipeRight.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "swipe-right" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [
		[
			"path",
			{
				"d": "M4 12a4 4 0 1 1 8 0a4 4 0 0 1 -8 0z"
			}
		],
		["path", { "d": "M12 12h8" }],
...
class IconSwipeRight extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSwipeRight$1 = IconSwipeRight;

export { IconSwipeRight$1 as default };
//# sourceMappingURL=IconSwipeRight.svelte.js.map
