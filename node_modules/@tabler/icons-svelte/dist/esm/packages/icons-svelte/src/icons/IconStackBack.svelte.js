...
/* src/icons/IconStackBack.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "stack-back" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconStackBack extends SvelteComponent {
	constructor(options) {
		super();
...
var IconStackBack$1 = IconStackBack;

export { IconStackBack$1 as default };
//# sourceMappingURL=IconStackBack.svelte.js.map
