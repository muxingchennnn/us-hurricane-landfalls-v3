...
/* src/icons/IconStackFront.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "stack-front" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconStackFront extends SvelteComponent {
	constructor(options) {
		super();
...
var IconStackFront$1 = IconStackFront;

export { IconStackFront$1 as default };
//# sourceMappingURL=IconStackFront.svelte.js.map
