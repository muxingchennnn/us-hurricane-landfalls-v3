...
/* src/icons/IconSwipeLeft.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "swipe-left" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [
		[
			"path",
			{
				"d": "M20 12a4 4 0 1 0 -8 0a4 4 0 0 0 8 0z"
			}
		],
		["path", { "d": "M12 12h-8" }],
...
class IconSwipeLeft extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSwipeLeft$1 = IconSwipeLeft;

export { IconSwipeLeft$1 as default };
//# sourceMappingURL=IconSwipeLeft.svelte.js.map
