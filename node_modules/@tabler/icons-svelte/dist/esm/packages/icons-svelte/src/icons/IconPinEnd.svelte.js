...
/* src/icons/IconPinEnd.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pin-end" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPinEnd extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPinEnd$1 = IconPinEnd;

export { IconPinEnd$1 as default };
//# sourceMappingURL=IconPinEnd.svelte.js.map
