...
/* src/icons/IconHospital.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hospital" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHospital extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHospital$1 = IconHospital;

export { IconHospital$1 as default };
//# sourceMappingURL=IconHospital.svelte.js.map
