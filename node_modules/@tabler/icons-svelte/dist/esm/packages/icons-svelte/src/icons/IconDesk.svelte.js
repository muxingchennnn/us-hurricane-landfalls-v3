...
/* src/icons/IconDesk.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "desk" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconDesk extends SvelteComponent {
	constructor(options) {
		super();
...
var IconDesk$1 = IconDesk;

export { IconDesk$1 as default };
//# sourceMappingURL=IconDesk.svelte.js.map
