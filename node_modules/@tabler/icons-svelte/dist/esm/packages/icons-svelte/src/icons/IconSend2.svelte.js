...
/* src/icons/IconSend2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "send-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSend2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSend2$1 = IconSend2;

export { IconSend2$1 as default };
//# sourceMappingURL=IconSend2.svelte.js.map
