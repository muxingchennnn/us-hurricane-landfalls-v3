...
/* src/icons/IconSwipeUp.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "swipe-up" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSwipeUp extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSwipeUp$1 = IconSwipeUp;

export { IconSwipeUp$1 as default };
//# sourceMappingURL=IconSwipeUp.svelte.js.map
