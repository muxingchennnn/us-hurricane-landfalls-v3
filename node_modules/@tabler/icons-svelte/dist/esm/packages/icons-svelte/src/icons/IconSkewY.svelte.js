...
/* src/icons/IconSkewY.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "skew-y" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSkewY extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSkewY$1 = IconSkewY;

export { IconSkewY$1 as default };
//# sourceMappingURL=IconSkewY.svelte.js.map
