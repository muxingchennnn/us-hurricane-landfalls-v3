...
/* src/icons/IconSkewX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "skew-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSkewX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSkewX$1 = IconSkewX;

export { IconSkewX$1 as default };
//# sourceMappingURL=IconSkewX.svelte.js.map
