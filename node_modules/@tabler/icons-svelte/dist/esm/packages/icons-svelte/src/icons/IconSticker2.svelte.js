...
/* src/icons/IconSticker2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "sticker-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconSticker2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconSticker2$1 = IconSticker2;

export { IconSticker2$1 as default };
//# sourceMappingURL=IconSticker2.svelte.js.map
