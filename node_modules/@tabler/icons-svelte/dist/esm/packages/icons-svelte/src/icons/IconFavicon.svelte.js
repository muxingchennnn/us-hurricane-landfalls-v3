...
/* src/icons/IconFavicon.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "favicon" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconFavicon extends SvelteComponent {
	constructor(options) {
		super();
...
var IconFavicon$1 = IconFavicon;

export { IconFavicon$1 as default };
//# sourceMappingURL=IconFavicon.svelte.js.map
