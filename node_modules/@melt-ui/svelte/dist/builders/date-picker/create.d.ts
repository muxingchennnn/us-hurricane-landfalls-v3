...
export declare function createDatePicker(props?: CreateDatePickerProps): {
    elements: {
        ...
        label: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Readable<boolean>, import("svelte/store").Writable<boolean>, import("svelte/store").Writable<string>], (node: HTMLElement) => {
            destroy: () => void;
        ...
        grid: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Writable<boolean>, import("svelte/store").Writable<boolean>], import("svelte/action").Action<any, any, Record<never, any>>, ([$readonly, $disabled]: [boolean, boolean]) => {
            tabindex: number;
            role: string;
            'aria-readonly': "true" | undefined;
            'aria-disabled': "true" | undefined;
    ...
    options: {
        ...
        onOutsideClick: import("svelte/store").Writable<((event: PointerEvent) => void) | undefined>;
        ...
        weekdayFormat: import("svelte/store").Writable<"long" | "short" | "narrow">;
        ...
        popoverIds?: import("svelte/store").Writable<Partial<{
            content: string;
            trigger: string;
        }> | undefined> | undefined;
    };
