...
export declare function setCtx<Multiple extends boolean>(props: CreateCalendarProps<Multiple>): {
    ...
    elements: {
        ...
        cell: import("@melt-ui/svelte/internal/helpers").ExplicitBuilderReturn<[import("svelte/store").Readable<(date: import("@internationalized/date").DateValue) => boolean>, import("svelte/store").Readable<(date: import("@internationalized/date").DateValue) => boolean>, import("svelte/store").Writable<import("@melt-ui/svelte").Matcher | undefined>, import("svelte/store").Readable<(date: import("@internationalized/date").DateValue) => boolean>, {
...
export declare function getCtx(): {
    ...
    states: {
        ...
        months: import("svelte/store").Writable<import("@melt-ui/svelte").Month<import("@internationalized/date").DateValue>[]>;
        value: {
            update: (updater: import("svelte/store").Updater<import("@internationalized/date").DateValue | import("@internationalized/date").DateValue[] | undefined>, sideEffect?: ((newValue: import("@internationalized/date").DateValue | import("@internationalized/date").DateValue[] | undefined) => void) | undefined) => void;
            set: (this: void, value: import("@internationalized/date").DateValue | import("@internationalized/date").DateValue[] | undefined) => void;
            subscribe(this: void, run: import("svelte/store").Subscriber<import("@internationalized/date").DateValue | import("@internationalized/date").DateValue[] | undefined>, invalidate?: import("svelte/store").Invalidator<import("@internationalized/date").DateValue | import("@internationalized/date").DateValue[] | undefined> | undefined): import("svelte/store").Unsubscriber;
        };
        weekdays: import("svelte/store").Readable<string[]>;
        headingValue: import("svelte/store").Readable<string>;
    };
